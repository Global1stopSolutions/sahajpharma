          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            {step === 3 && (
              <div className="flex flex-col sm:grid sm:grid-cols-3 gap-x-unit-md gap-y-unit-2xl">
                ...
                <div className="formcontainer filecontainer">
                  <label className="text-base text-content1-charlestonGreen font-medium label-hidden after:text-danger"></label>
            ...
            <div className="mt-unit-xl flex justify-end space-x-unit-md">
              {step > 1 && (
                <ButtonDefault variant="btn-primary" onPress={prevStep} title="Previous" />
              )}
